...
getMediaForFragmentList = Request.request service method  where
    service = Request.ServiceName "KinesisVideoArchivedMedia"
    method = Request.MethodName "getMediaForFragmentList"
...
listFragments = Request.request service method  where
    service = Request.ServiceName "KinesisVideoArchivedMedia"
    method = Request.MethodName "listFragments"
